...
print('split End')
#フィッティング
etr = RandomForestRegressor(n_estimators=2500,bootstrap=True,n_jobs=1, random_state=0)
...
print('R2,RMSE RandomForest End')

#計算時間
elapsed_time = time.time() - start
print ("{0}".format(elapsed_time) + "[sec]")
print(len(dataset),len(dd))
...
df_dif.to_csv('M:/UserDir/y_hcr_motohashi/Desktop/data_3/result/andom_gosa_09.csv')
df.to_csv('M:/UserDir/y_hcr_motohashi/Desktop/data_3/result/random_gosa_0109.csv')


plt.bar(df['Difference'], 
        df['Amount'],
        color='lightblue', 
        align='center') 
